                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <?php if(isset($val->house_name)): ?>
                                                                                            <?php if(is_array($areas)): ?>
                                                                                                <a href="<?php echo e(route('forthebuilder.house-flat.show', $val->house_flat_id)); ?>" class="btn btn-primary klientNameInformatsiaButtonKontactYellow" house_id="<?php echo e($val->house_id??'NULL'); ?>" house_flat_id = "<?php echo e($val->house_flat_id??'NULL'); ?>" client_id = "<?php echo e($val->client_id??'NULL'); ?>"
                                                                                                        id="interested_flat">
                                                                    ...
                                                                    <div class="informatsiyaKlienta">
                                                                        <table class="table table-striped table-bordered mb-0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <th><?php echo e(translate('Files')); ?></th>
                                                                                    <td>
                                                                                        <button data-bs-toggle="modal" data-bs-target="#all_files_modal" class="btn btn-outline-primary all_files_view" data-id="<?php echo e($val->deal_id); ?>">
                                                                                            <?php echo e(translate('All files')); ?>

                                                                                        </button>
                                                                                        <button data-bs-toggle="modal" data-bs-target="#upload_files_modal" class="btn btn-outline-info">
                                                                                            <?php echo e(translate('Attach file')); ?>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <button type="submit" data-bs-toggle="modal"
                                                                                            client_id="<?php echo e($val->client_id); ?>" deal_id="<?php echo e($deal_id); ?>"
                                                                                            personal_id="<?php echo e($val->personal_id); ?>" deal_status="<?php echo e($val->type); ?>"
                                                                                            class="PerviyContact PerviyContactRed status_button client-show-change-status btn btn-secondary btn-sm"
                                                                                            data-series_number="<?php echo e($val->series_number); ?>"
                                                                                            budget="<?php echo e($val->budget); ?>" looking_for="<?php echo e($val->looking_for); ?>"
                                                                                            data-inn="<?php echo e($val->inn); ?>"
                                                                                            data-issued_by="<?php echo e($val->issued_by); ?>"
                                                                                ...
                                                                                foreach ($tasks as $data_task) {
                                                                                    if($data_task->deal_id == $val->deal_id){
                                                                                        ...
                                                                                        if (strtotime($task_date[0]) == $dates_unique) {
                                                                                            ...
                                                                                            $task_array[] = ['performer' => (($data_task->performer != null) ? $data_task->performer->first_name . ' ' . $data_task->performer->last_name . ' ' . $data_task->performer->middle_name : ''), 'title' => $data_task->title, 'type' => $data_task->type, 'id' => $data_task->id, 'answer' => $data_task->answer, 'created' => $data_task->created_at];
                                                                                        }
                                                                                    }
                                                                                            ...
                                                                                            <div class="mt-2 mb-3">
                                                                                                <?php if(isset($data_h->new_type) && $data_h->new_type != ''): ?>
                                                                                                    ...
                                                                                                    <?php switch($data_h->new_type):
                                                                                                        ...
                                                                                                        <?php break; ?>
                                                                                                        <?php case ('Cancel deal'): ?>
                                                                                                        <span
                                                                                                                class="smsGreenData badge bg-secondary"><?php echo e(translate('Cancel a deal')); ?></span>
                                                                                                        <?php break; ?>
                                                                                                    <?php endswitch; ?>
                                                                                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>">
                                                                        ...
                                                                        <textarea row="4" placeholder="<?php echo e(translate('Description')); ?>" class="form-control task_title" name="task_title" rows="1"></textarea>
                                                                        <?php if(Auth::user()->role_id != Constants::GUEST): ?>
                                                                            <div class="d-flex justify-content-end mt-2">
                        ...
                        <div class="modal-content store_budget_form">
                            <form class="modal-body" id="store_budget_"
                                ...
                                <div>
                                    ...
                                    <div class="mb-2 form-check-primary">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" placeholder="<?php echo e(translate('Issued by (Date of issue and expiration date)')); ?>" name="given_date"
...
<div class="modal fade" id="select_flat_modal" tabindex="-2" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
...
<div class="modal fade" id="all_files_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<div class="modal fade" id="upload_files_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('forthebuilder.clients.storePhoto')); ?>" method="POST" class="d-flex justify-content-around" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('POST'); ?>
                    ...
                    <button class="inforMatsiyaClienti2MiniPlusButton btn btn-primary ms-3" type="submit">
    ...
    <script>
        $(document).on('click','.all_files_view',function(){
            var deal_id = $(this).attr('data-id')
            $.ajax({
                url: `/clients/view-all-files/`,
                type: 'GET',
                data: {
                    deal_id: deal_id
                },
                success: function(data) {
                    $('#all_files_modal .modal-body').html(data)
                },
                error: function(data) {
                    console.log(data);
                }
        ...
        // upload_new_files
        $(document).on('click','.upload_new_files',function(){
           $('#myAwesomeDropzone').unbind('submit').submit();            
        })
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/icstroy/Modules/ForTheBuilder/Resources/views/clients/show.blade.php ENDPATH**/ ?>