                                        ...
                                        <?php if(empty(!$value)): ?>
                                            <?php $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    ?>
                                                    <button
                                                        class="jkHouseGreen btn-filter-flat flat-button flat-button-open-modal p-2 rounded mb-1"
                            ...
                            <tr>
                                <td>
                                    <div class="custom-select modalSelect">
                                        <select class="selectModal selectModalDiv2 form-control" id="select5">
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/icstroyc/admin.icstroy.com/Modules/ForTheBuilder/Resources/views/house/show-details.blade.php ENDPATH**/ ?>