        ...
        <?php if(!empty($model)): ?> 
            ...
            <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keym => $valuem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td style="width: 150px; text-align: center;">
                        <?php echo e(((!empty($valuem->initial_fee_discount) && !empty($valuem->initial_fee)) ? $valuem->initial_fee_discount.'%' : '-')); ?>
...
</table><?php /**PATH /Users/user/Desktop/laravel/icstroy/Modules/ForTheBuilder/Resources/views/exports/deals-all.blade.php ENDPATH**/ ?>