                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="ovalChart m-0 w-100">
                                <h5><?php echo e(translate('Individual sales')); ?></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="chartDiv bigProdajZaMesyach lidiMarginRight2 m-0">
                                <h5><?php echo e(translate('Sales per month')); ?></h5>
                                <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="chartDiv lidiMarginRight2 m-0" >
                                <h5 class="chart1Individual "><?php echo e(translate('Individual sales managers')); ?></h5>
                                <div>
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/icstroyc/admin.icstroy.com/Modules/ForTheBuilder/Resources/views/user/filtr.blade.php ENDPATH**/ ?>