                                ...
                                <div class="d-flex dropdownsBron">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdownBodyKalendar" aria-labelledby="dropdownMenuButton"
                                            ...
                                            <a class="dropdown-item yearNameKalendar2" href="<?php echo e(route('forthebuilder.deal.create')); ?>"><?php echo e(translate('Sell')); ?></a>
                                    ...
                                    <div class="custom-select PerviyContactGreen2 ms-auto">
                                        <input type="hidden" id="model_id" value="<?php echo e($model->id); ?>">
                                        
                                        <select class="option_status select_bron form-control" id="option_status" >
                                            <option>
            ...
            <div class="modal-content modalMyJk2">
                ...
                <div class="modal-header border border-0">
                    <div class="d-flex justify-content-between w-100">
                        <div class="nomerKvartiraChenaKvartiri">
                            <div>
                                <?php echo e(translate('Apartment number')); ?>: 
                                <b class="apartment_number">
                                    <?php echo e((int) $model->prepayment); ?> sum
                                </b>    
                            </div>
                            <div>
                                <?php echo e(translate('Apartment price')); ?>:
                                <b class="apartment_price">41850 у.е.</b>     
                            </div>                            
                        </div>
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/icstroyc/admin.icstroy.com/Modules/ForTheBuilder/Resources/views/booking/show.blade.php ENDPATH**/ ?>