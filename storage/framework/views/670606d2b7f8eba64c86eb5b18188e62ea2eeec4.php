...
<script defer>
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            models.href.push('<?php echo e(route('forthebuilder.clients.show', [$model_->deal->client->id, '0', '0'])); ?>')
            ...
            my_models.href.push('<?php echo e(route('forthebuilder.clients.show', [$my_model_->deal->client->id, '0', '0'])); ?>')
            ...
            var calendar = new Calendar(calendarEl, {
                ...
                events: [
                        ...
                        ?>
                    {
                        ...
                        customHtml : "<span><?php echo e($model->performer->first_name.' '); ?><?php echo e($model->performer->last_name); ?> <br> <?php echo e($model->user->first_name); ?></span>",
