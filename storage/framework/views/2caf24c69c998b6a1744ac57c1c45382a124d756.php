...
<head>
    ...
    <!-- <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('backend-assets/forthebuilders/images/favicon.ico')); ?>"> -->
...
<body>
    ...
    <script defer src="<?php echo e(asset('/backend-assets/forthebuilders/javascript/bootstrap.js')); ?>"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"
        integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous">
    </script>
    <script defer src="<?php echo e(asset('/backend-assets/forthebuilders/javascript/main.js')); ?>"></script>
    ...
    <script>
        ...
        $(document).on('click', '.attach-order', function() {
            ...
            <br>
            <button class="btn sozdatImyaSpisokSozdatButtonSave basket-to-house float-right mt-0"><?php echo e(translate('Next')); ?></button>
            `)
        })
        ...
        // $(".save-flats").unbind('click').bind('click', function () {
            ...
            if (number == 'p') {
                ...
                $('#exampleModal .modal-body').find('form .change_content').html(`
                    ...
                    <div class="mt-3">
                        <h3 class="sozdatJkSpisokH3722"><?php echo e(translate('Hotel')); ?></h3>
                        <input type="number" name="hotel" class="modalMiniCapsule4 text-left">
                    </div>

                    <div class="mt-3">
                        <h3 class="sozdatJkSpisokH3722"><?php echo e(translate('Bedroom')); ?></h3>
                    ...
                    <div class="mt-3">
                        <h3 class="sozdatJkSpisokH3722"><?php echo e(translate('Terrace')); ?> <input type="checkbox" id="terassa"></h3>
                        <input type="number" placeholder="" name="terassa" class="modalMiniCapsule4 text-left" id="terassa_input" disabled>
                    </div>

                    <div class="mt-3">
                        <h3 class="sozdatJkSpisokH3722"><?php echo e(translate('Balcony')); ?> <input type="checkbox" id="balcony"></h3>
...
<?php /**PATH /Users/user/Desktop/laravel/ikcrm_release/Modules/ForTheBuilder/Resources/views/layouts/forthebuilder.blade.php ENDPATH**/ ?>