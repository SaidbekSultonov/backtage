...
<script>
    ...
    $(document).on('click','.save_percent',function(){
        ...
        if(id != ''){
            ...
            $.ajax({
                  url: `/installment-plan/save-percent`,
                  type: 'post',
                  data: {id: id},
    ...
    $(document).on('click','.delete_percent',function(){
        ...
        if(confirm(confirm_text)){
            $.ajax({
                url: `/installment-plan/delete-percent`,
                type: 'post',
                data: {id: id},
                success: function (data) {
                    if(data.status == false){
    ...
    $(document).on('click','.accept_percent',function(){
        ...
        $.ajax({
                url: `/installment-plan/update-percent`,
                type: 'post',
                data: {
                    id: id,
                    percent: percent
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/icstroy/Modules/ForTheBuilder/Resources/views/installment-plan/settings.blade.php ENDPATH**/ ?>