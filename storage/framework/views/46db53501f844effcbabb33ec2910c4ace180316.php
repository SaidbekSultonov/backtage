...
<div>
    <div class="col-md-11">
        ...
        <?php if($for): ?>
            <?php echo e(translate('The green ones are attached')); ?>
    ...
    <div class="col-md-11">
        ...
        <?php if($for): ?>
            <?php echo e(translate('The red ones are not attached')); ?>
                                ...
                                <div class="d-flex align-items-start">
                                    <?php $__currentLoopData = $val2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div style="min-width: 60px; height: 60px;">
                                            ...
                                            <?php
                                                $color = '#FB3030';
                                                if (!empty($val3['company_details_id'])) {
                                                    $color = '#44BE26';
                                                }
                                            ?>
...
<?php /**PATH /Users/user/Desktop/laravel/icstroy/Modules/ForTheBuilder/Resources/views/house/price-formation-flats.blade.php ENDPATH**/ ?>