...
<script>
    ...
    $(document).on('click','.save_filtr',function(){
        ...
        $.ajax({
            url: `/forthebuilder/filtr-houses`,
            type: 'GET',
            datatype: 'json',
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/icstroy/Modules/ForTheBuilder/Resources/views/filtr.blade.php ENDPATH**/ ?>