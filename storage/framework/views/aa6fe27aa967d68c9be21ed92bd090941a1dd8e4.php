            ...
            <div class="card">
                <div class="card-body p-2 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <?php if(Auth::user()->role_id != Constants::MANAGER && Auth::user()->role_id != Constants::GUEST): ?>
...
<script defer>
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            models.name.push('<?php echo e(((!empty($model_->deal->client)) ? $model_->deal->client->first_name : '')); ?>')
            models.surname.push('<?php echo e(((!empty($model_->deal->client)) ? $model_->deal->client->last_name : '')); ?>')
            models.middlename.push('<?php echo e(((!empty($model_->deal->client)) ? $model_->deal->client->middle_name : '')); ?>')
            models.created_at.push('<?php echo e($model_->created_at); ?>')
            models.email.push('<?php echo e(((!empty($model_->performer)) ? $model_->performer->email : '')); ?>')
            ...
            var calendar = new Calendar(calendarEl, {
                ...
                events: [
                        ...
                        ?>
                    {
                        ...
                        url: '#',
                        title : "<?php echo e(((!empty($model->performer)) ? $model->performer->first_name : '')); ?> <br> <?php echo e($model->status); ?> <?php echo e($model->type); ?>",
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/icstroy/Modules/ForTheBuilder/Resources/views/clients/calendar.blade.php ENDPATH**/ ?>