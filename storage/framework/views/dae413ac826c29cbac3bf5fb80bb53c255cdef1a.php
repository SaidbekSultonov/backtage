                    ...
                    <div class="row align-items-center w-100 m-0">
                        ...
                        <div class="col-md-5 text-end">
                            <a class="btn btn-outline-primary" href="<?php echo e(route('forthebuilder.deal.index')); ?>">
                                <span><?php echo e(translate('Deals')); ?></span>
                            </a>
                        </div>
                        <div class="col-md-3">
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/icstroyc/admin.icstroy.com/Modules/ForTheBuilder/Resources/views/clients/index.blade.php ENDPATH**/ ?>