    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li data="<?php echo e($acton); ?>" class="list <?php echo e((($acton == 'forthebuilder.task.index' || $acton == 'forthebuilder.clients.calendar') ? 'menuitem-active' : '')); ?>">
                ...
                <!--  -->
                <li data="<?php echo e($acton); ?>" class="list <?php echo (($acton == 'forthebuilder.clients.edit') ? 'menuitem-active' : '') ?>">
                ...
                <!--  -->
                <li data="<?php echo e($acton); ?>" class="list <?php echo (($acton == 'forthebuilder.house.show-more' || $acton == 'forthebuilder.house.show-details' || $acton == 'forthebuilder.house-flat.show' || $acton == 'forthebuilder.house-flat.edit') ? 'menuitem-active' : '') ?>">
                ...
                <?php if(Auth::user()->role_id==Constants::ADMIN || Auth::user()->role_id==Constants::SUPERADMIN): ?>
                <!--  -->
                    <li data="<?php echo e($acton); ?>" class="list <?php echo (($acton == 'forthebuilder.user.show' || $acton == 'forthebuilder.user.edit' || $acton == 'forthebuilder.user.filtr') ? 'menuitem-active' : '') ?>">
                ...
                <?php endif; ?>
                <!--  -->
                <li data="<?php echo e($acton); ?>" class="list <?php echo (($acton == 'forthebuilder.currency.index' || $acton == 'forthebuilder.language.index' || $acton == 'forthebuilder.language.show' || $acton == 'forthebuilder.language.edit' || $acton == 'forthebuilder.coupon.index' || $acton == 'forthebuilder.house.price-formation' || $acton == 'forthebuilder.installment-plan.settings') ? 'menuitem-active' : '') ?>">
...
<?php /**PATH /home/icstroyc/admin.icstroy.com/Modules/ForTheBuilder/Resources/views/layouts/content/navigation.blade.php ENDPATH**/ ?>