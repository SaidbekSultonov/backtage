            ...
            <div class="sdelkaData">
                ...
                <?php if(empty(!$models)): ?>
                    ...
                    <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(isset($value->client) && $value->client->status == Constants::CLIENT_ACTIVE): ?>
                            <div class="jkMiniData mb-1 hideData">
                                <input type="hidden" class="hiddenData"
                                    value="<?php echo e($value->x ? $value->client->last_name . ' ' . $value->client->first_name . ' ' . $value->client->middle_name : ''); ?> <?php echo e($value->house->name ?? ''); ?> <?php echo e($value->price_sell ?? ''); ?> <?php echo e($value->tasks ? $value->tasks->title : $defaultAction[$value->type]); ?>">
                                <div class="d-flex lidiHrefBigLidiData">
                                    <a href="<?php echo e(route('forthebuilder.clients.show', [$value->client->id, '0', '0'])); ?>" class="checkboxDivInput">
                                        <?php echo e($n++); ?>

                                        
                                    </a>
                                    <a href="<?php echo e(route('forthebuilder.clients.show', [$value->client->id, '0', '0'])); ?>" class="checkboxDivTextInput">
                                        <?php echo e($value->client ? $value->client->last_name . ' ' . $value->client->first_name . ' ' . $value->client->middle_name : ''); ?>

                                    </a>
                                    <a href="<?php echo e(route('forthebuilder.clients.show', [$value->client->id, '0', '0'])); ?>" class="ObjextSdelki">
                                        <?php echo e($value->house->name ?? ''); ?>
                                    ...
                                    <?php
                                        $sdelkaClass = '';
                                        if ($value->type == Constants::FIRST_CONTACT) {
                                            $sdelkaClass = 'dataSdelkaJkPinkNthChild';
                                        } elseif ($value->type == Constants::NEGOTIATION) {
                                            $sdelkaClass = 'dataSdelkaJkYellowNthChild';
                                        } else {
                                            $sdelkaClass = 'dataSdelkaJkGreenNthChild';
                                        }
                                    ?>
                                    <a href="<?php echo e(route('forthebuilder.clients.show', [$value->client->id, '0', '0'])); ?>" class="dataSdelkaJk <?php echo e($sdelkaClass); ?>">
                                        
                                        <?php echo e($value->tasks ? $value->tasks->title : $defaultAction[$value->type]); ?>

                                    </a>
                                </div>

                                <div class="deystvieSdelka">
                                    <a style='margin-right: 10px;' href="<?php echo e(route('forthebuilder.clients.edit', $value->client->id)); ?>" class="seaDiv">
                                    ...
                                    <button type="button" style="border: none; cursor: pointer;"
                                        ...
                                        data-url="<?php echo e(route('forthebuilder.clients.destroy', $value->client->id)); ?>">
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/ikcrm_release/Modules/ForTheBuilder/Resources/views/clients/index.blade.php ENDPATH**/ ?>