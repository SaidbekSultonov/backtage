<div style="margin: 50px 100px; padding: 0 100px;" id="DivIdToPrint">
  ...
  <table width="100%">
    <tr>
      <td style="font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">Sana: <?php echo e($data['date_deal']); ?></td>
  ...
  <p style="font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    <b style="font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">“CITY CONSTRUCTION MASTER” MChJ</b> va uning nomidan harakat qiluvchi direktor <b style="font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">TOSHPULOTOV HUSAN ALIYOROVICH</b> keyingi o‘rinlarda — “Quruvchi” deb yuritiladi bir tomondan, fuqaro <b><?php echo e($data['last_name']); ?> <?php echo e($data['first_name']); ?> <?php echo e($data['middle_name']); ?></b>, <b style="font-size: 12px;"><?php echo e(($data['passport_or_id'] == 1) ? 'passport' : 'ID'); ?></b> <b><?php echo e(($data['passport_or_id'] == 1) ? 'seriyasi' : 'karta №'); ?> <?php echo e($data['series_number']); ?></b>, <b><?php echo e(date('d.m.Y', strtotime($data['given_date']))); ?> yilda <?php echo e($data['issued_by']); ?></b> berilgan, bundan buyon matnda — “Ulushdor” deb yuritiladi, ushbu Shartnomani quyidagilar haqida tuzdik:
  </p>
  ...
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    2.1. Ulushdor quruvchi tomonidan Qurilish majmuasi joylashgan manzil: Toshkent shahar Yangi Hayot tumani Qipchoq ko`chasi 18A manzilida qurilayotgan qurilish majmuasining qurilishi uchun har bir kvadrat metr uchun Ulushdor sotib olayotgan xonadonning 1 (bir) kvadrat metr uchun belgilangan narxi <b><?php echo e(number_format($data['price_sell_m2'], 2)); ?></b> so‘mdan, jami Ulushdor sotib olayotgan xonadon uchun kiritiladigan ulushning umumiy miqdori <b><?php echo e(number_format($data['price_sell'], 2)); ?></b> so‘m miqdorida ulush kiritish, Quruvchi esa yuqoridagi manzilda joylashgan uyning: korpus: <b><?php echo e($data['corpus']); ?></b>, qavat raqami: <b><?php echo e($data['floor']); ?></b>, xonalar soni: <b><?php echo e($data['room_count']); ?></b>, ulushdorga mulk qilib berish majburiyatini oladi.
  </div>
  <div>
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
  ...
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    2.2.1. <b><?php echo e($data['total_m2']); ?></b> metr kvadratni tashkil etadi;
  </div>
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    2.2.2. Yashash xonalarining umumiy soni <b><?php echo e($data['room_count']); ?> ta</b>;
  </div>
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    2.2.3. Yashash xonalarining umumiy maydoni <b><?php echo e($data['live_m2']); ?> kv/m</b>;
  </div>
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    2.2.4. Yashash xonalarining umumiy maydoni <b><?php echo e($data['total_m2']); ?> </b> kv/m tashkil etadi ;
  </div>
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    2.2.5. Oshxonaning umumiy maydoni <b><?php echo e($data['kitchen_m2']); ?> </b> kv/m tashkil etadi ;
  </div>
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    2.2.6. Yordamchi xona (dahliz) umumiy maydoni <b><?php echo e($data['attic_m2']); ?> </b> kv/m tashkil etadi ;
  </div>
  ...
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
    3.1.  Ulushdor tomonidan kiritiladigan ulushning umumiy summasi <b><?php echo e(number_format($data['price_sell'], 2)); ?></b> so‘mni tashkil etadi. Ulush depozitining belgilangan hajmi o‘zgartirilishi mumkin emas.
  </div>
  <div style="text-indent: 30px;font-family: Times New 'Times New Roman', Times, serif; font-size: 12px;">
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/icstroyc/admin.icstroy.com/Modules/ForTheBuilder/Resources/views/deal/new_print.blade.php ENDPATH**/ ?>