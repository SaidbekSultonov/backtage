                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        <div class="text-center">   
                            <img src="<?php echo e(asset('/backend-assets/img/favicon-removebg-preview.png')); ?>" alt="" class="w-50">
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password">
                                    ...
                                    <div class="form-group mathcaptcha-label-input ">
                                        ...
                                        <label for="mathgroup" class="mathcaptcha-label mx-2"> <?php echo e(app('mathcaptcha')->label()); ?></label>
                                    ...
                                    <div class="mb-2">
                                        <?php if($errors->has('mathcaptcha')): ?>
                                            <span class="error-data" id="has-error-message">
                                                <span><?php echo e(translate('Код подтверждения недействителен')); ?></span>
                                            </span>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <a class="color" href="<?php echo e(route('password.request')); ?>">
...
<?php /**PATH /home/icstroyc/admin.icstroy.com/resources/views/auth/login.blade.php ENDPATH**/ ?>