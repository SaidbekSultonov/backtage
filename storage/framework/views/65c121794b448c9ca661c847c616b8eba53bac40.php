...
<div id="DivIdToPrint">
                    ...
                    <tr style="margin-top: 24px;">
                        <td style="height: 90px;">
                            <div style="text-align: center; width:330px; margin-top: 30px">
                                <i style="margin-top: 50px; font-size: 11px;">Дата составления : </i>
                                <p style="font-size: 11px;"><?php echo e(date('d-m-Y')); ?></p>
                            </div>
                        </td>
                        ...
                        <td style="height: 90px;">
                            <div style="text-align: right; width:300px; margin-top: 30px">
                                <i style="margin-left:-44px;margin-top: 50px; font-size: 11px; opacity: 0.5">Прайс
                                    актуален до:</i>
                                <p style="font-size: 11px;"><?php echo e($day_two_week); ?></p>
                            </div>
                        </td>
                    </tr>
                    <br>
                        ...
                        <td style="font-size: 11px;">
                            <div style="margin-top: 64px; margin-right: 44px; width:330px">
                                ...
                                <div style="height:12px; margin: -7px 0px 15px 0px">
                                    <b>Цена за 1 м2 </b> <b style="padding-left: 30px;">  <?php echo e($price_100); ?> сум  </b>
                                                    

                                </div>
                                <div style="height:12px">
                                    <b>Общая стоимость </b>
                                    <b><?php echo e($full_price_100); ?></b><br>
                                    <hr style="color: #0F120F; margin-top:1px">
                                </div>
                                <div style="height:12px ; margin-top:10px">
                                    <b style="color:green">Сумма скидки</b>
                                    <b><?php echo e($sale_100); ?></b><br>
                                    <hr style="color: #0F120F; margin-top:1px">
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="width: 900px ">
                        <td style="font-size: 11px; margin-bottom: 44px;">
                            ...
                            <div style="width:330px; ">
                                ...
                                <div style="height:12px; margin-top:10px">
                                    <b>Цена за 1 м<sup>2</sup></b> <b style="padding-left: 30px;">  <?php echo e($price_50); ?> сум  </b>

                                    <hr style="color: #0F120F; margin-top:1px">
                                </div>
                                <div style="height:12px; margin-top:10px">
                                    <b>Общая стоимость</b>
                                    <b><?php echo e($full_price_50); ?></b>
                                    <hr style="color: #0F120F; margin-top:1px">
                                </div>
                                <div style="height:12px;  margin-top:10px">
                                    <b style="color:green">Сумма скидки</b>
                                    <b><?php echo e($sale_50); ?></b><br>
                                    <hr style="color: #0F120F; margin-top:1px">
                                </div>
                            </div>
                            <div style="width:330px; margin-top: 24px">
                                ...
                                <div style="height:12px ; margin-top:10px">
                                    <b>Цена за 1 м<sup>2</sup></b> <b style="padding-left: 30px;">  <?php echo e($price_30); ?> сум  </b>
                                    <hr style="color: #0F120F; margin-top:1px">
                                </div>
                                <div style="height:12px ; margin-top:10px">
                                    <b>Общая стоимость</b>
                                    <b><?php echo e($full_price_30); ?></b>
                                    <hr style="color: #0F120F; margin-top:1px">
                                </div>
                            </div>
                        </td>
            ...
            <table class="table">
                <tbody>
                    <tr>
                        ...
                        <td style="font-size: 11px; width: 150px; padding-left:170px;">
    ...
    <?php if($guid): ?>
        <div style="margin-top: 300px;">
            ...
            <img style="width:100%; height: 400px"  class="homeSozdatImage1272" src="<?php echo e(asset('/uploads/house-flat/' . $house->id . '/l_' . $guid)); ?>" alt="Home">
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/icstroy/Modules/ForTheBuilder/Resources/views/house-flat/print.blade.php ENDPATH**/ ?>