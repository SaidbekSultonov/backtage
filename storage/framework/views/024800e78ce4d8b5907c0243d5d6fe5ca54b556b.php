                ...
                <div class="card-body p-2 d-flex justify-content-between align-items-center">
                    <div class="row align-items-center w-100">
                        <div class="col-md-10 d-flex align-items-center">                            
                            <h4 class="ms-3">
                                <?php echo e(translate('Installment types')); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped table-sm">
                        <thead>
                            <th>№</th>
                            <th><?php echo e(translate('Percent')); ?></th>
                            ...
                            <?php if(!empty($model)): ?> <?php $i = 1; ?> 
                                <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td>
                                            <input type="number" disabled class="form-control percent_value" value="<?php echo e($value->percent_type); ?>" style="width: 100px">
...
<script>
    ...
    $(document).on('click','.save_percent',function(){
        ...
        if(id != ''){
            ...
            $.ajax({
                  url: `/forthebuilder/installment-plan/save-percent`,
                  type: 'post',
                  data: {id: id},
    ...
    $(document).on('click','.delete_percent',function(){
        ...
        if(confirm(confirm_text)){
            $.ajax({
                url: `/forthebuilder/installment-plan/delete-percent`,
                type: 'post',
                data: {id: id},
                success: function (data) {
                    if(data.status == false){
    ...
    $(document).on('click','.accept_percent',function(){
        ...
        $.ajax({
                url: `/forthebuilder/installment-plan/update-percent`,
                type: 'post',
                data: {
                    id: id,
                    percent: percent
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/icstroyc/admin.icstroy.com/Modules/ForTheBuilder/Resources/views/installment-plan/settings.blade.php ENDPATH**/ ?>