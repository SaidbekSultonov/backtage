...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid py-3 px-2">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="deal-create-form" action="<?php echo e(route('forthebuilder.deal.update',$model->id)); ?>" method="POST"enctype="multipart/form-data"> <?php echo csrf_field(); ?> <?php echo method_field("PUT"); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col form-group">
                                            ...
                                            <input id="dateInput" placeholder="<?php echo e(date('d.m.Y')); ?>" type="text" name="date_deal" class="date_picker form-control sozdatImyaSpisokSelectOptionJkProdnoDate <?php $__errorArgs = ['date_deal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-data-input is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e($clients != 'NULL' ? $clients->birth_date : '', old('birth_date')); ?>" type="text" name="birth_date" id="birth_date">
                                        <span class="error-data invalid-feedback">
...
unset($__errorArgs, $__bag); ?>"
                                            type="text" name="series_number" id="series_number" value="
                                            <?php echo (($clients->informations) ? $clients->informations->series_number : old('series_number'))  ?>">
                                        <div class="keyUpNameResult d-none bg-secondary">
                                        </div>
                                        <span class="error-data invalid-feedback">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo (($clients->informations) ? $clients->informations->given_date : old('given_date'))  ?>" type="text" name="given_date" id="given_date">
                                        <span class="error-data invalid-feedback">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo (($clients->informations) ? $clients->informations->issued_by : old('issued_by'))  ?>" type="text" name="issued_by" id="issued_by">
                                        <span class="error-data invalid-feedback">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo (($clients->informations) ? $clients->informations->issued_by : old('issued_by'))  ?>" type="text" name="live_address"
                                            id="live_address">
                                        <span class="error-data invalid-feedback">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo (($clients->informations) ? $clients->informations->inn : old('inn'))  ?>" type="text" name="inn" id="inn">
                                        <span class="error-data invalid-feedback">
                                            <?php $__errorArgs = ['inn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
                                ...
                                <div class="p-2 border rounded mt-3 bg-light">
                                    ...
                                    <div class="sozdatImyaSpsok mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input placeholder="<?php echo e((($domain == 'businesshouse.icstroy.com') ? '+996' : '+998')); ?>" class="form-control keyUpName booking-phone <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-data-input is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="sozdatImyaSpsok">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input placeholder="<?php echo e((($domain == 'businesshouse.icstroy.com') ? '+996' : '+998')); ?>" class="form-control keyUpName booking-additional_phone <?php $__errorArgs = ['additional_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error-data-input is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="polniy_DropDown">
                                            ...
                                            <input id="dateInput3" class="date_picker form-control sozdatImyaSpisokDropDown"
                                                type="text" name="installment_date" placeholder="<?php echo e(date('d.m.Y')); ?>">
                                            <span class="error-data invalid-feedback">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-sm12 mt-3">
                                <button type="submit" class="btn btn-outline-success sozdatImyaSpisokSozdatButtonSave saveDealDogovor">
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/icstroy/Modules/ForTheBuilder/Resources/views/deal/edit.blade.php ENDPATH**/ ?>