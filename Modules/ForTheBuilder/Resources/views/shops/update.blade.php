        ...
        <div class="container-fluid py-3 px-2">
                ...
                <div class="card-body p-2 d-flex justify-content-center align-items-center">
                    <div class="row w-100 align-items-center">
                        <div class="col-12 d-flex justify-content-start align-items-center">
                            ...
                            <h4 class="ms-3">{{translate('Update shop')}}</h4>   
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body d-flex justify-content-center align-items-center">
                    <form class="w-100" action="{{route('forthebuilder.shops.save')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <input type="hidden" name="id" value="{{ $model->id }}">
                        <div class="row">
                            <div class="col-6 mb-2">
                                <label class="form-label" for="">{{ translate('Name') }}</label>
                                <input type="text" class="form-control @error('name') error-data-input is-invalid @enderror" name="name" value="{{ $model->name }}">
                            ...
                            <div class="col-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="brend" value="{{ $model->brend }}">
                            </div>

                            <div class="col-6 mb-2">
                                <label class="form-label" for="">{{ translate('Торговое помещение') }}</label>
                                <input type="text" class="form-control" name="torg" value="{{ $model->torg }}">
                            </div>
