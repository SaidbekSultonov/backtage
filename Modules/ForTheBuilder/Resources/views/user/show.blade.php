                            ...
                            <div class="row">
                                <div class="col-sm-8 d-flex">
                                    <div class="d-flex align-items-center">
                                        @if($model->role_id != Constants::SUPERADMIN)
                                            @if(isset($model->id))
                                                @php
                                        ...
                                        <p class="profileOtherData my-0">
                                            @if($model->last_seen > time())
                                                <span class="online_status badge bg-success">
                                                    <span class="in_online_status">{{ translate('Online') }}</span>
                                                </span>
                                            @else
                                                <span class="offline_status badge bg-secondary">
                                                    <span class="in_offline_status">
                                                        @if($model->last_seen != 0)
                                                            @if($mins < 120 && $mins > 1)
                                                                {{ translate('Last seen') }} 
                                                                {{ $mins }} 
                                                                {{ translate('minuts ago') }}
                                                            @elseif($mins <= 1)
                                                                {{ translate('Last seen recently') }} 
                                                            @else
                                                                {{ 
                                                                    translate('Last seen') }} {{ date('d.m.Y H:i', $model->last_seen)
                                                                }}
                                                            @endif
                                                        @else
                                                            {{ translate('Last seen a long time ago')}}
                                                        @endif
                                                    </span>
                                                </span>
                                            @endif
                                ...
                                <div class="widget-chart-1">
                                    <div class="widget-chart-box-1 float-start" dir="ltr">
                                        <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#f05050 "
                                               ...
                                               @php echo (($data['all_clients_count'] > 0 ) ? round((100/$data['all_clients_count'])*$data['new_clients'],2) : 0) @endphp %"
