                ...
                <div class="card-body p-2 d-flex justify-content-between align-items-center">
                    <div class="row w-100 m-0">
                        <div class="col-md-4 d-flex align-items-center">
                            <a href="{{route('forthebuilder.user.report-clients')}}" class="plus2 profileMaxNazadInformatsiyaKlient">
                        ...
                        <div class="col-md-8 d-flex align-items-center justify-content-end text-end">
                            ...
                            <a target="_blank" href="{{ route('forthebuilder.exports.export',$id) }}" class="btn btn-outline-success btn-xs">
